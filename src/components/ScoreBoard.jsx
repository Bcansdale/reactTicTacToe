...
import {useState, useEffect} from "react"; // Import useState to set an initial value

// This function will increment the score of each player via 'x', 'o', or a 'tie' game
// All react components must be capitalized
function ScoreBoard({scores, setScores, winner}) {
...
//     });
    ...
    }, [winner]); // Dependency array ensures this runs when 'winner' changes
