...
function App() {
    return (
        <>
            <img className='rounded mx-auto img-fluid mt-1' src={DevMountain} alt="Dev Mountain Logo" width='90'/>
            <div className="container mx-auto mt-2 border-2 border-black rounded-4">
